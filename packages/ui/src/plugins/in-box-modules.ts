 ...
 * in `docs/plugin-contract.md`'s "known gaps" and again here: the frozen
 * contract supports a plugin shipped from a directory or a configured
 ...
 * is ported onto the frozen contract yet, so this list has nothing to carry —
