/**
 * The Jira plugin's **renderer-side** manifest (§10.1's renderer half).
 *
 ...
 *   `@plotroom/ui`'s `ContributionRegistry` — nothing that talks to Jira.
 *
 ...
 */
export const JIRA_PLUGIN_IDENTITY = {
  id: "jira",
  name: "Jira",
  version: "1.0.0",
  contractVersion: 1,
