...
- `bun.lock` changes only through Bun commands (`bun add`, `bun install`,
  `bun update`). A hand-edited lockfile breaks turbo's semantic lockfile
  reading and CI's affected-package selection.
